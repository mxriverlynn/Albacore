...
The old syntax still works, too. You can still call <code>Albacore::NCoverConsole.new(...) do ... end</code> in your rakefile. The new syntax shortcut is just that - a shortcut. You don't need to specify <code>Albacore::</code> and you don't need to speify the <code>.new</code> initializer.
